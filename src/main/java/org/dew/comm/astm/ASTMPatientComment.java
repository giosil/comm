...
public 
class ASTMPatientComment implements IRecord
{
  ...
  public ASTMPatientComment()
  {
  }
  
  public ASTMPatientComment(String sCode)
  {
    this.code = sCode;
  }
  
  public ASTMPatientComment(String sCode, String sText)
  {
    this.code = sCode;
    this.text = sText;
  }
